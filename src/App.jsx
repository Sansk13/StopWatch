...
function App() {
  ...
  return (
    <>
      <div className="max-w-md flex flex-col items-center justify-center p-4 m-auto bg-gray-200 rounded-lg shadow-lg">
        <h1 className="text-2xl font-semibold">StopWatch</h1>
        <div className="text-xl font-semibold py-4"></div>
        <div>
